...
api_desc = [
    ...
    {
        "request": "/api/get_list/manga_name",
        "request_type": "GET",
        "type_output": " JSON || None",
    ...
    {
        "request": "/api/get_list/manga_chapters",
        "request_type": "GET",
        "type_output": " JSON || None",
